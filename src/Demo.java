...
import iiitb.ess201a7.r16052.Fleet16052;
...
public class Demo {
	...
	public static void main(String[] args) {
		...
		{
			Fleet f1 = new Fleet16052("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);

			f1 = new Fleet16024("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);

			f1 = new Fleet16073("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);

			f1 = new Fleet16095("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);

			f1 = new Fleet16114("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);
		}
